...
def get_bam_config(
    credentials, decoding_method="greedy", max_new_tokens=200, repetition_penalty=1.2
):
    """Configure BAM Model"""
    ...
    bam_config = {"client": client, "generate_params": params}
    return bam_config
...
def get_related_examples(inputs, dynamic_shots_cfg, max_num_egs_in_prompt):
    ...
    """
    inputs_embeddings = dynamic_shots_cfg["rag_model"].encode(
