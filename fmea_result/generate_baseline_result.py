...
from performance_study import setup_few_shot_retrieval, get_bam_config, get_related_examples
...
def process_model_perm(llm_model,
    ...
    bam_config = get_bam_config(credentials=creds,
    ...
    dfsp_fls, raw_responses = generate_components(step_1_data["short_descriptions"],
                                                dynamic_shots_cfg,
                                                llm_model['name'],
                                                bam_config,
...
def run_pipeline_on_split(split, val_model):
    ...
    for llm_model in all_llm_models:
        ...
        for perm in perms:
            ...
            step_1_data = process_model_perm(llm_model, step_1_data, creds, dynamic_shots_cfg, exp_conf, perm)
...
step_1_data_val = run_pipeline_on_split("val_data", val_model)
